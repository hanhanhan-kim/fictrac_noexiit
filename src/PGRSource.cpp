...
PGRSource::PGRSource(int index)
{
    try {
        ...
        // Set StreamBufferHandlingMode to Newest First
        // -------------------------------------------------------------------------------------------------
        GenApi::INodeMap& sNodeMap = _cam->GetTLStreamNodeMap();
        ...
        std::cout << std::endl << "New Buffer Handling Mode: " << ptrHandlingModeEntry->GetDisplayName() << std::endl;
        // -------------------------------------------------------------------------------------------------
